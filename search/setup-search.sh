...
# RHEL9/Rocky9 want sha2 .... There's probably another answer to this problem. 
#
...
dnf -y  install --enablerepo=elasticsearch elasticsearch kibana

# Need to edit/copy elasticsearch.yml here:
# TODO
